...
module tb_waveform_gen;
    ...
    task test_case;
        ...
        input expected_fail;         // If 1, this test is expected to fail (known issue)
        ...
        begin
            ...
            if (error < -1 || error > 1) begin
                if (expected_fail) begin
                    $display("XFAIL: Test %0d - instrument=%0d, pitch=%0d, buzz=%0b, noiz=%0b (KNOWN ISSUE)",
